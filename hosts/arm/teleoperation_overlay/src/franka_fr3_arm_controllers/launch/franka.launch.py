...
def generate_robot_nodes(context):
    ...
    arm_prefix_value = LaunchConfiguration("arm_prefix").perform(context)
    ...
    nodes = [
        ...
        Node(
            ...
            executable="spawner",
            namespace=namespace,
            # These parameters belong to the controller node, not the spawner.
            arguments=[
                "franka_robot_state_broadcaster",
                "--controller-ros-args",
                (
                    "--ros-args "
                    f"-p arm_prefix:={arm_prefix_value} "
                    f"-p robot_type:={arm_id_value}"
                ),
            ],
